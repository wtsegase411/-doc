...
number_of_rows = 250  # len(pd_dataframe.index) + 1
...
number_of_rows_perfile = 250  # random.randint(min_rows, max_rows)
...
while True:
    ...
    ## Target file name
    split_target_file = f"{base_dir[:-4]}_{file_increment} 250 rows .csv"
